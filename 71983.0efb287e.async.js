"use strict";(self.webpackChunk_yuntijs_ui=self.webpackChunk_yuntijs_ui||[]).push([[71983],{58479:function(Rn,J,n){n.d(J,{b:function(){return B}});var k=n(26068),t=n.n(k),G=n(67825),A=n.n(G),S=n(21153),U=n(75271),Z=n(53649),r=n.n(Z),T=n(47512),d,E=(0,T.kc)(function(C,b){var h=C.css,R=b.bordered,p=R===void 0?"dashed":R;return{custom:h(d||(d=r()([`
    ...
    `])),Dn?In?nn.colorFill:nn.colorBgElevated:In?nn.colorFillSecondary:nn.colorBgContainer,nn.borderRadiusLG,nn.motionEaseOut),cn=w(h||(h=y()([`
      padding-block-start: `,`;
    `])),Qn?0:"6px"),An=w(R||(R=y()([`
      margin-block-end: -16px;
      transition: background-color 100ms `,`;
    `])),nn.motionEaseOut),te=Un==="block"?Pn:cn,re=zn&&w(p||(p=y()([`
        width: 100%;
      `])));return{actions:en(w(L||(L=y()([`
          flex: none;
          align-self: `,`;
          justify-content: `,`;
        `])),On==="left"?"flex-start":"flex-end",On==="left"?"flex-end":"flex-start"),zn&&w(j||(j=y()([`
      ...
      `])),Zn,Zn),avatarGroupContainer:w(O||(O=y()([`
        width: `,`px;
      `])),Zn),container:en(Un==="pure"&&An,w(z||(z=y()([`
          position: relative;
          width: 100%;
          max-width: 100vw;
          padding: 16px;
        ...
        `])),vn?"unset":"none",vn?1:0,nn.motionEaseOut,Mn.mobile,Un==="pure"?"12px":"6px")),editingContainer:en(re,w(x||(x=y()([`
        ...
        `])),nn.colorBorderSecondary,nn.colorBorder),Un==="pure"&&w(N||(N=y()([`
            background: `,`;
            border-radius: `,`px;
      ...
      `])),On==="right"?"-4px":"unset",On==="left"?"-4px":"unset",nn.colorBgLayout,nn.colorPrimary),message:en(te,w(q||(q=y()([`
        ...
        color: `,`;
        text-align: `,`;
      `])),nn.colorTextDescription,On==="left"?"left":"right")}}),W=n(52676),an=(0,E.memo)(function(g){var Y=g.editing,en=g.onChange,w=g.onEditingChange,nn=g.text,In=g.message,Mn=g.placement,On=g.messageExtra,Un=g.renderMessage,Qn=g.type,Dn=g.primary,Zn=g.onDoubleClick,zn=g.fontSize,qn=g.markdownProps,vn=g.markdownClassname,Pn=I({editing:Y,placement:Mn,primary:Dn,type:Qn}),cn=Pn.cx,An=Pn.styles,te=(0,d.F)(),re=te.mobile,tn=(0,W.jsx)(a.i,{classNames:{input:An.editingInput,markdown:vn},editButtonSize:"small",editing:Y,fontSize:zn,fullFeaturedCodeBlock:!0,markdownProps:qn,onChange:en,onEditingChange:w,openModal:re?Y:void 0,text:nn,value:In?String(In).trim():""}),Vn=Un?Un(tn):tn;return(0,W.jsxs)(u.D,{className:cn(An.message,Y&&An.editingContainer),onDoubleClick:Zn,children:[Vn,On&&!Y?(0,W.jsx)("div",{className:An.messageExtra,children:On}):null]})}),M=an,yn=["avatarAddon","onAvatarClick","avatarProps","actions","className","primary","loading","message","placement","type","avatar","error","showTitle","time","editing","onChange","onEditingChange","messageExtra","renderMessage","text","errorMessage","onDoubleClick","fontSize","markdownProps","markdownClassname","isLatest"],on=32,En=(0,E.memo)(function(g){var Y=g.avatarAddon,en=g.onAvatarClick,w=g.avatarProps,nn=g.actions,In=g.className,Mn=g.primary,On=g.loading,Un=g.message,Qn=g.placement,Dn=Qn===void 0?"left":Qn,Zn=g.type,zn=Zn===void 0?"block":Zn,qn=g.avatar,vn=g.error,Pn=g.showTitle,cn=g.time,An=g.editing,te=g.onChange,re=g.onEditingChange,tn=g.messageExtra,Vn=g.renderMessage,he=g.text,Ee=g.errorMessage,De=g.onDoubleClick,pe=g.fontSize,je=g.markdownProps,Ue=g.markdownClassname,dn=g.isLatest,m=A()(g,yn),V=(0,d.F)(),D=V.mobile,gn=I({editing:An,placement:Dn,primary:Mn,showTitle:Pn,time:cn,title:qn.title,type:zn,isLatest:dn}),bn=gn.cx,pn=gn.styles;return(0,W.jsxs)(u.D,t()(t()({className:bn(pn.container,In),direction:Dn==="left"?"horizontal":"horizontal-reverse",gap:D?6:12},m),{},{children:[(0,W.jsx)(U.Z,t()(t()({},w),{},{addon:Y,avatar:qn,loading:On,onClick:en,placement:Dn,size:D?on:void 0})),(0,W.jsxs)(u.D,{align:Dn==="left"?"flex-start":"flex-end",className:pn.messageContainer,children:[(0,W.jsx)(T.Z,{avatar:qn,placement:Dn,showTitle:Pn,time:cn}),(0,W.jsxs)(u.D,{align:Dn==="left"?"flex-start":"flex-end",className:pn.messageContent,direction:"vertical",gap:8,children:[vn?(0,W.jsx)(r.Z,{error:vn,message:Ee,placement:Dn}):(0,W.jsx)(M,{editing:An,fontSize:pe,markdownClassname:Ue,markdownProps:je,message:Un,messageExtra:tn,onChange:te,onDoubleClick:De,onEditingChange:re,placement:Dn,primary:Mn,renderMessage:Vn,text:he,type:zn}),(0,W.jsx)(S.Z,{actions:nn,editing:An,placement:Dn,type:zn})]})]}),D&&zn==="block"&&(0,W.jsx)(Z.Z,{borderSpacing:on})]}))})},13306:function(Rn,J,n){n.d(J,{U:function(){return z}});var k=n(26068),t=n.n(k),G=n(48305),A=n.n(G),S=n(67825),U=n.n(S),Z=n(97157),r=n(86818),T=n(44923),d=n(71170),E=n(75271),u=n(84569),a=n.n(u),B=n(53649),y=n.n(B),C=n(47512),b,h,R,p,L,j=(0,C.kc)(function(x){var N=x.css,_=x.token,Q=x.prefixCls;return{root:N(b||(b=y()([`
      overflow: hidden;
    `]))),wrapper:N(h||(h=y()([`
...
`);return JSON.stringify({root:{children:i.map(function(o){return{children:[{detail:0,format:0,mode:"normal",style:"",text:o,type:"custom-text",version:1}],direction:"ltr",format:"",indent:0,type:"paragraph",version:1}}),direction:"ltr",format:"",indent:0,type:"root",version:1}})}var sn=(0,a.memo)(function(s){var i=s.onInsert,o=(0,F.g)(),e=$()(o,1),l=e[0];(0,a.useEffect)(function(){if(!l.hasNodes([pe]))throw new Error("MentionNodePlugin: MentionNode not registered on editor")},[l]);var c=(0,a.useCallback)(function(rn){i&&i();var ln=rn.getTextContent().slice(2,-2);return(0,u.U2)(je(ln))},[i]),P=(0,a.useCallback)(function(rn){var ln=Ee.exec(rn);if(ln===null)return null;var un=ln.index,K=un+ln[0].length;return{end:K,start:un}},[]),H=(0,a.useCallback)(function(rn){return Ee.lastIndex=0,bn(rn,P,c)},[c,P]);return(0,a.useEffect)(function(){return Ee.lastIndex=0,(0,Y.qV)(l.registerNodeTransform(N,H))},[]),null}),kn=n(99934),$n=n(64287),Ln=n(30967),Bn=n(83606),_n=function(s){O()(o,s);var i=x()(o);function o(e){var l,c=e.label,P=e.value,H=e.data,rn=e.icon,ln=e.extraElement,un=e.keywords,K=e.keyboardShortcut,Cn=e.disabled,Nn=e.onSelect,Sn=e.children,Fn=e.isChild;return C()(this,o),l=i.call(this,P),A()(X()(l),"label",void 0),A()(X()(l),"value",void 0),A()(X()(l),"title",void 0),A()(X()(l),"key",void 0),A()(X()(l),"icon",void 0),A()(X()(l),"extraElement",void 0),A()(X()(l),"keywords",void 0),A()(X()(l),"keyboardShortcut",void 0),A()(X()(l),"onSelect",void 0),A()(X()(l),"disabled",void 0),A()(X()(l),"data",void 0),A()(X()(l),"children",void 0),A()(X()(l),"isChild",void 0),l.value=P,l.label=c,l.title=c,l.key=P,l.keywords=un||[],l.icon=rn,l.extraElement=ln,l.keyboardShortcut=K,l.onSelect=Nn.bind(X()(l)),l.disabled=Cn,l.data=H,l.isChild=Fn!=null?Fn:!1,l.children=Sn==null?void 0:Sn.map(function(wn){return new o(t()(t()({},wn),{},{isChild:!0}))}),l}return h()(o)}(kn.n),le=function s(i,o){var e;return i.children=(e=i.children)===null||e===void 0?void 0:e.filter(function(l){if(!l.children)return o(l);var c=s(l,o);return o(l)||(c.children||[]).length>0}),i},Kn=function(i,o){var e=(0,F.g)(),l=$()(e,1),c=l[0],P=(0,a.useCallback)(function(rn){var ln,un=new RegExp((0,Bn.Z)(o),"i");return un.test(rn.label)||((ln=rn.keywords)===null||ln===void 0?void 0:ln.some(function(K){return un.test(K)}))||!1},[o]),H=(0,a.useMemo)(function(){var rn=function un(K){var Cn=t()(t()({},K),{},{children:void 0,onSelect:function(){c.dispatchCommand(tn,K.value)}});return K.children&&(Cn.children=K.children.map(function(Nn){return un(Nn)})),Cn},ln=i.map(function(un){return new _n(rn(un))});return o?ln.map(function(un){return un.children?le(un,P):un}).filter(function(un){return P(un)||(un.children||[]).length>0}):ln},[i,o,c,P]);return{options:H}},ne=n(78962),jn=n(94729),se,oe,ae,Gn,ce,ve,ie,Xn=(0,Pn.kc)(function(s,i){var o=s.css,e=s.token,l=s.prefixCls,c=i.isSelected,P=i.disabled,H=o(se||(se=vn()([`
    ...
    `])),e.colorFillSecondary);return{anchor:o(oe||(oe=vn()([`
      ...
      `])),e.colorInfoText),menuItemLabel:o(ie||(ie=vn()([`
        ...
        text-overflow: ellipsis;
        white-space: nowrap;
      `])))}}),Yn=jn.C.Text,xn=(0,a.memo)(function(s){var i=s.index,o=s.isSelected,e=s.onClick,l=s.onMouseEnter,c=s.option,P=s.queryString,H=s.showIcon,rn=H===void 0?!0:H,ln=Xn({isSelected:o,disabled:c.disabled}),un=ln.styles,K=c.label,Cn=(0,a.useMemo)(function(){var wn=K,de="",Be="";if(P){var We=new RegExp((0,Bn.Z)(P),"i"),Se=We.exec(c.label);Se&&(wn=K.slice(0,Math.max(0,Se.index)),de=Se[0],Be=K.slice(Math.max(0,Se.index+Se[0].length)))}return{before:wn,middle:de,after:Be}},[c.label,P,K]),Nn=Cn.before,Sn=Cn.middle,Fn=Cn.after;return(0,M.jsxs)(I.Z,{align:"center",className:un.menuItem,gap:4,onClick:function(){return e==null?void 0:e(i,c)},onMouseEnter:function(){return l==null?void 0:l(i,c)},ref:c.setRefElement,tabIndex:-1,children:[rn&&(0,M.jsx)(I.Z,{className:un.menuItemIcon,children:c.icon}),(0,M.jsxs)("div",{className:un.menuItemLabel,title:c.label,children:[Nn,(0,M.jsx)(Yn,{mark:!0,children:Sn}),Fn]}),(0,M.jsx)(I.Z,{children:c.extraElement})]},c.key)});xn.displayName="MentionMenuItem";var mn=(0,a.memo)(function(s){var i=s.selectedIndex,o=s.options,e=s.onClick,l=s.onMouseEnter,c=s.queryString,P=Xn({}),H=P.styles;return(0,M.jsxs)(M.Fragment,{children:[o.length===0&&(0,M.jsx)(ne.Z,{className:H.menuEmpty,image:ne.Z.PRESENTED_IMAGE_SIMPLE}),o.map(function(rn,ln){return(0,M.jsx)(xn,{index:ln,isSelected:i===ln,onClick:e,onMouseEnter:l,option:rn,queryString:c},rn.key)})]})}),fn=(0,a.memo)(function(s){var i=s.overlayClassName,o=s.triggers,e=s.options,l=e===void 0?[]:e,c=s.allowSpaces,P=c===void 0?!0:c,H=s.punctuation,rn=H===void 0?en:H,ln=s.preTriggerChars,un=ln===void 0?w:ln,K=s.onSelect,Cn=Xn({}),Nn=Cn.cx,Sn=Cn.styles,Fn=(0,F.g)(),wn=$()(Fn,1),de=wn[0],Be=zn(o,{punctuation:rn,preTriggerChars:un,allowSpaces:P}),We=Be.trigger,Se=Be.checkForMentionMatch,Xe=(0,a.useState)(null),Ve=$()(Xe,2),Pe=Ve[0],Ye=Ve[1],Je=Kn(l,Pe),Te=Je.options,Ge=(0,a.useCallback)(function(ee,Le,Qe,Ie){K==null||K(ee,We,Pe),de.update(function(){Le&&ee!==null&&ee!==void 0&&ee.key&&Le.remove(),ee!=null&&ee.onSelect&&ee.onSelect(Ie),Qe()})},[de,K,Pe,We]),fe=(0,a.useCallback)(function(ee){var Le=ee.selectedIndex,Qe=ee.selectOptionAndCleanUp;return(0,M.jsx)(E.ZP,{theme:{components:{Tree:{indentSize:16,lineHeight:32,titleHeight:32,paddingXS:0}}},children:(0,M.jsx)($n.Z,{blockNode:!0,defaultExpandAll:!0,onExpand:function(Ne,ge){var be=ge.nativeEvent;be.stopPropagation(),de.dispatchCommand(he,{})},onSelect:function(Ne,ge){Qe(ge.node)},titleRender:function(Ne){var ge;return(0,M.jsx)(xn,{isSelected:((ge=Te[Le])===null||ge===void 0?void 0:ge.value)===Ne.value,option:Ne,queryString:Pe,showIcon:!Ne.isChild})},treeData:Te})})},[Te,de,Pe]),Ke=(0,a.useCallback)(function(ee,Le,Qe){var Ie=Le.selectedIndex,Ne=Le.selectOptionAndCleanUp,ge=Le.setHighlightedIndex;return ee.current?Ln.createPortal((0,M.jsx)("div",{className:Nn(Sn.menuOverlay,i),role:"menu",children:Te.some(function(be){return(be.children||[]).length>0})?fe(Le):(0,M.jsx)(mn,{onClick:function(Fe,$e){$e.disabled||(ge(Fe),Ne($e))},onMouseEnter:function(Fe,$e){$e.disabled||ge(Fe)},options:Te,queryString:Pe,selectedIndex:Ie})}),ee.current):null},[Nn,Te,i,Pe,fe,Sn.menuOverlay]);return(0,M.jsx)(kn.HQ,{anchorClassName:Sn.anchor,menuRenderFn:Ke,onQueryChange:Ye,onSelectOption:Ge,options:Te,triggerFn:Se})}),Wn=function(i){var o=i.onBlur,e=i.onFocus,l=(0,F.g)(),c=$()(l,1),P=c[0],H=(0,a.useRef)(null);return(0,a.useEffect)(function(){return(0,Y.qV)(P.registerCommand(he,function(){return H.current&&(clearTimeout(H.current),H.current=null),!0},u.VN),P.registerCommand(u.Gq,function(rn,ln){return H.current=setTimeout(function(){P.dispatchCommand(u.Zq,new KeyboardEvent("keydown",{key:"Escape"}))},200),o&&o(),!0},u.VN),P.registerCommand(u.m$,function(){return e&&e(),!0},u.VN))},[P,o,e]),null},Tn=Wn,Hn,Jn,Ce,Oe,Me,xe,ye,Ae,Re=32,ze=22,hn=function(i){return Re+Math.max(i-1,0)*ze},me=(0,Pn.kc)(function(s,i){var o=s.css,e=s.token,l=s.prefixCls,c=i.autoSize;return{wrapper:o(Hn||(Hn=vn()([`
        position: relative;
        display: inline-block;
        width: 100%;
        min-width: 0;
      ...
      `]))),disabled:o(Ae||(Ae=vn()([`
        ...
        color: `,`;
        background: `,`;
      `])),e.colorTextDisabled,e.colorBgContainerDisabled)}}),ue=function(i){var o=i.className,e=i.classNames,l=i.placeholder,c=i.style,P=i.value,H=i.defaultValue,rn=i.readOnly,ln=rn===void 0?!1:rn,un=i.disabled,K=i.onChange,Cn=i.onBlur,Nn=i.onFocus,Sn=i.variant,Fn=Sn===void 0?"outlined":Sn,wn=i.options,de=wn===void 0?[]:wn,Be=i.autoSize,We=i.triggers,Se=We===void 0?["@"]:We,Xe=i.allowSpaces,Ve=i.punctuation,Pe=i.preTriggerChars,Ye=i.onSelect,Je=E.ZP.useConfig(),Te=Je.componentDisabled,Ge=me({autoSize:Be}),fe=Ge.styles,Ke=Ge.cx,ee=un!=null?un:Te,Le=!ln&&!ee,Qe=(0,a.useMemo)(function(){return{namespace:"mentions",nodes:[N,{replace:u.R2,with:function(be){return new N(be.__text)}},pe],editorState:pn(P||H||""),onError:function(be){throw be}}},[]),Ie=function(be){var Fe=be.read(function(){return(0,u.Gv)().getTextContent()});K==null||K(Fe.replaceAll(`

`,`
`))},Ne=(0,a.useMemo)(function(){var ge=function be(Fe,$e){return Fe.reduce(function(He,Ze){if(He[Ze.value]=Ze,He[Ze.value].icon||(He[Ze.value].icon=$e),Ze.children&&Ze.children.length>0){var we=be(Ze.children,Ze.icon);Object.assign(He,we)}return He},{})};return ge(de)},[de]);return B.j?(0,M.jsx)(S.R,{initialConfig:t()(t()({},Qe),{},{editable:Le}),children:(0,M.jsx)(on,{value:{optionsMap:Ne},children:(0,M.jsxs)("div",{className:Ke(fe.wrapper,e==null?void 0:e.wrapper),children:[(0,M.jsx)(d.B,{ErrorBoundary:Z.g,contentEditable:(0,M.jsx)(U.f,{className:Ke(A()(A()(A()(A()({},fe.root,!0),fe.filled,Fn==="filled"),fe.borderless,Fn==="borderless"),fe.disabled,ee),o),style:c||{}}),placeholder:(0,M.jsx)("div",{className:fe.placeholder,children:l||"\u8F93\u5165 ".concat(Se.join(" \u6216 ")," \u63D2\u5165\u5F15\u7528")})}),(0,M.jsx)(fn,{allowSpaces:Xe,onSelect:Ye,options:de,overlayClassName:e==null?void 0:e.menuOverlay,preTriggerChars:Pe,punctuation:Ve,triggers:Se}),(0,M.jsx)(dn,{}),(0,M.jsx)(sn,{}),(0,M.jsx)(r.e,{}),(0,M.jsx)(T.$,{onChange:Ie}),(0,M.jsx)(Tn,{onBlur:Cn,onFocus:Nn})]})})}):(0,M.jsxs)("div",{className:Ke(fe.wrapper,e==null?void 0:e.wrapper),children:[(0,M.jsx)("div",{className:Ke(A()(A()(A()(A()({},fe.root,!0),fe.filled,Fn==="filled"),fe.borderless,Fn==="borderless"),fe.disabled,ee),o),style:c||{}}),(0,M.jsx)("div",{className:fe.placeholder,children:l||"\u8F93\u5165 ".concat(Se.join(" \u6216 ")," \u63D2\u5165\u5F15\u7528")})]})}},97527:function(Rn,J,n){n.d(J,{u:function(){return b}});var k=n(26068),t=n.n(k),G=n(67825),A=n.n(G),S=n(51697),U=n(75271),Z="yunti-ui",r=n(53649),T=n.n(r),d=n(47512),E,u,a=(0,d.kc)(function(R,p){var L=R.css,j=R.prefixCls,f=p.borderd,O=f===void 0?!0:f,z=p.footer,x=z===null||Array.isArray(z)&&z.length===0,N=L(E||(E=T()([`
      .`,`-modal-header::after {
        content: ' ';
    ...
    `]))),Kn=function(){switch(_n){case"outlined":return D.colorBgBase;case"filled":return D.colorFillTertiary;default:return"transparent"}};return{base:V(In||(In=en()([`
      ...
      `])),Kn(),_n==="outlined"?D.colorBorder:"transparent",D.borderRadius,_n==="outlined"?D.colorPrimaryHover:"transparent",_n==="filled"&&V(Mn||(Mn=en()([`
          ...
          `])),D.colorFillSecondary),_n==="filled"&&V(On||(On=en()([`
            background-color: `,`;
          `])),D.colorBgBase),_n!=="borderless"&&V(Un||(Un=en()([`
            border-color: `,`;
      ...
      `])),gn,D.colorTextSecondary,kn?V(zn||(zn=en()([`
                z-index: 9999;
                right: `,`px;
      ...
      `])),D.fontSizeSM,D.colorTextTertiary,le)}},{hashPriority:"low"}),cn=n(52676);function An(){}var te=function(m){var V,D=m.onChange,gn=m.enableOutline,bn=m.width,pn=m.height,sn=m.language,kn=m.supportFullScreen,$n=(0,r.useRef)(D),Ln=En("single",m),Bn=Ln.isEditorReady,_n=Ln.focused,le=Ln.loading,Kn=Ln.containerRef,ne=Ln.monacoRef,jn=Ln.editorRef,se=Ln.valueRef,oe=(0,r.useRef)(),ae=g(jn==null?void 0:jn.current),Gn=ae.isFullScreen,ce=ae.fullScreen,ve=Pn({isFullScreen:Gn,minimapEnabled:(V=m.options)===null||V===void 0||(V=V.minimap)===null||V===void 0?void 0:V.enabled,variant:m.variant}),ie=ve.cx,Xn=ve.styles,Yn=ie(Xn.base,m.className,{"ve-focused":_n,"ve-outline":gn}),xn=(0,r.useMemo)(function(){return{width:bn,height:pn}},[bn,pn]);return(0,r.useEffect)(function(){$n.current=D},[D]),(0,r.useEffect)(function(){if(Bn){var mn,fn=jn.current;(mn=oe.current)===null||mn===void 0||mn.dispose(),oe.current=fn==null?void 0:fn.onDidChangeModelContent(function(Wn){var Tn,Hn=fn==null||(Tn=fn.getModel())===null||Tn===void 0?void 0:Tn.getValue();if(se.current!==Hn){var Jn;(Jn=$n.current)===null||Jn===void 0||Jn.call($n,Hn,Wn)}})}},[jn,Bn,oe,se]),(0,r.useEffect)(function(){return function(){var mn,fn,Wn,Tn=jn.current;(mn=oe.current)===null||mn===void 0||mn.dispose(),Tn==null||(fn=Tn.getModel())===null||fn===void 0||fn.dispose(),(Wn=jn.current)===null||Wn===void 0||Wn.dispose()}},[jn]),(0,r.useEffect)(function(){var mn;if(Bn){var fn=(mn=jn.current)===null||mn===void 0?void 0:mn.getModel();if(fn){var Wn;(Wn=ne.current)===null||Wn===void 0||Wn.editor.setModelLanguage(fn,sn)}}},[jn,Bn,sn,ne]),(0,cn.jsxs)("div",{className:Yn,style:m.style,children:[le&&(0,cn.jsx)("span",{className:ie(Xn.loading,"loading"),children:W}),(0,cn.jsx)("div",{className:"react-monaco-editor-container",ref:Kn,style:xn,children:kn&&(0,cn.jsx)(E.ZP,{className:Xn.fullScreenBtn,icon:(0,cn.jsx)(d.Z,{icon:Gn?u.Z:a.Z}),onClick:ce,size:"small",type:"text"})})]})},re=function(m){var V=m.enableOutline,D=m.width,gn=m.height,bn=m.language,pn=m.onChange,sn=m.original,kn=m.supportFullScreen,$n=(0,r.useRef)(pn),Ln=En("diff",m),Bn=Ln.isEditorReady,_n=Ln.focused,le=Ln.loading,Kn=Ln.containerRef,ne=Ln.monacoRef,jn=Ln.editorRef,se=Ln.valueRef,oe=g(),ae=oe.isFullScreen,Gn=oe.fullScreen,ce=Pn({isFullScreen:ae,diff:!0,variant:m.variant}),ve=ce.cx,ie=ce.styles,Xn=ve(ie.base,m.className,{"ve-focused":_n,"ve-outline":V}),Yn=(0,r.useMemo)(function(){return{width:D,height:gn}},[D,gn]);return(0,r.useEffect)(function(){$n.current=pn},[pn]),(0,r.useEffect)(function(){var xn;if(Bn){(xn=jn.current.getModel())===null||xn===void 0||xn.original.setValue(sn!=null?sn:"");var mn=jn.current.getModel()||{},fn=mn.modified;fn==null||fn.onDidChangeContent(function(Wn){var Tn=fn.getValue();if(se.current!==Tn){var Hn;(Hn=$n.current)===null||Hn===void 0||Hn.call($n,Tn,Wn)}})}},[jn,Bn,sn,se]),(0,r.useEffect)(function(){return function(){var xn,mn,fn;(xn=jn.current)===null||xn===void 0||(xn=xn.getModel())===null||xn===void 0||(xn=xn.original)===null||xn===void 0||xn.dispose(),(mn=jn.current)===null||mn===void 0||(mn=mn.getModel())===null||mn===void 0||(mn=mn.modified)===null||mn===void 0||mn.dispose(),(fn=jn.current)===null||fn===void 0||fn.dispose()}},[jn]),(0,r.useEffect)(function(){var xn,mn,fn;if(Bn){var Wn=((xn=jn.current)===null||xn===void 0?void 0:xn.getModel())||{},Tn=Wn.original,Hn=Wn.modified;(mn=ne.current)===null||mn===void 0||mn.editor.setModelLanguage(Tn,bn),(fn=ne.current)===null||fn===void 0||fn.editor.setModelLanguage(Hn,bn)}},[jn,Bn,bn,ne]),(0,cn.jsxs)("div",{className:Xn,style:m.style,children:[le&&(0,cn.jsx)("span",{className:ve(ie.loading,"loading"),children:W}),(0,cn.jsx)("div",{className:"react-monaco-editor-container react-monaco-editor-diff-container",ref:Kn,style:Yn,children:kn&&(0,cn.jsx)(E.ZP,{className:ie.fullScreenBtn,icon:(0,cn.jsx)(d.Z,{icon:ae?u.Z:a.Z}),onClick:Gn,size:"small",type:"text"})})]})},tn=Object.assign(re,{displayName:"DiffMonacoEditor",defaultProps:{width:"100%",height:150,defaultValue:"",language:"javascript",options:an,editorDidMount:An,editorWillMount:An,onChange:An,requireConfig:{}}}),Vn=Object.assign(te,{displayName:"SingleMonacoEditor",defaultProps:{width:"100%",height:150,defaultValue:"",language:"javascript",options:an,editorDidMount:An,editorWillMount:An,onChange:An,requireConfig:{}},MonacoDiffEditor:tn}),he=null,Ee=["type","editorDidMount","readOnly","lineNumbers","wordWrap","contextmenu","theme","minimapEnabled","version","requireConfig","options","className","supportFullScreen"],De=["inlineView","options"],pe=function(m){var V=m.type,D=V===void 0?"single":V,gn=m.editorDidMount,bn=m.readOnly,pn=bn===void 0?!1:bn,sn=m.lineNumbers,kn=sn===void 0?"on":sn,$n=m.wordWrap,Ln=$n===void 0?"off":$n,Bn=m.contextmenu,_n=Bn===void 0?!0:Bn,le=m.theme,Kn=m.minimapEnabled,ne=Kn===void 0?!1:Kn,jn=m.version,se=jn===void 0?"0.45.0":jn,oe=m.requireConfig,ae=oe===void 0?{}:oe,Gn=m.options,ce=m.className,ve=m.supportFullScreen,ie=U()(m,Ee),Xn=(0,r.useRef)(gn);(0,r.useEffect)(function(){Xn.current=gn},[gn]);var Yn=(0,Z.r)(),xn=Yn.isDarkMode,mn=(0,r.useMemo)(function(){return le||(xn?"vs-dark":"vs")},[xn,le]),fn=(0,r.useState)(),Wn=A()(fn,2),Tn=Wn[0],Hn=Wn[1],Jn=(0,r.useCallback)(function(xe,ye){var Ae;Hn(ye),(Ae=Xn.current)===null||Ae===void 0||Ae.call(Xn,xe,ye)},[]),Ce=(0,r.useMemo)(function(){var xe=Object.assign({},Gn,{readOnly:pn,lineNumbers:kn,wordWrap:Ln,contextmenu:_n,minimap:ne===void 0?Gn==null?void 0:Gn.minimap:Object.assign({},Gn==null?void 0:Gn.minimap,{enabled:ne})});return Tn==null||Tn.updateOptions(xe),xe},[Gn,pn,kn,Ln,_n,ne,Tn]),Oe=(0,T.nc)(),Me=(0,r.useMemo)(function(){return Object.assign({},ae,{paths:t()({vs:Oe({path:"min/vs",pkg:"monaco-editor",version:se})},ae.paths)})},[Oe,ae,se]);return D!=="diff"?(0,cn.jsx)(Vn,t()({className:ce,editorDidMount:Jn,options:Ce,requireConfig:Me,supportFullScreen:Tn&&ve,theme:mn},ie)):(0,cn.jsx)(Vn.MonacoDiffEditor,t()({className:ce,editorDidMount:Jn,options:Ce,requireConfig:Me,supportFullScreen:Tn&&ve,theme:mn},ie))},je=function(m){return(0,cn.jsx)(pe,t()(t()({},m),{},{type:"single"}))},Ue=function(m){var V=m.inlineView,D=V===void 0?"off":V,gn=m.options,bn=U()(m,De);return(0,cn.jsx)(pe,t()(t()({options:Object.assign({useInlineViewWhenSpaceIsLimited:D==="on"||D==="auto",renderSideBySide:D==="off"||D==="auto"},gn)},bn),{},{type:"diff"}))}},64521:function(Rn,J,n){n.d(J,{Y:function(){return b}});var k=n(26068),t=n.n(k),G=n(67825),A=n.n(G),S=n(20219),U=n(75271),Z=n(53649),r=n.n(Z),T=n(47512),d,E,u,a,B=(0,T.kc)(function(p,L){var j=p.css,f=p.token,O=p.prefixCls,z=L.size,x=L.segmented,N=function(){return x?x!==!0?x.gap:!0:0}(),_=function(){if(x)return x!==!0?x.borderRadius:!0}(),Q=function(){var I={small:f.sizeSM,middle:f.size,large:f.sizeLG};return typeof N=="string"?I[N]:N===!0?z?I[z]:I.middle:N||0},X=function(){var I={small:f.controlHeightSM,middle:f.controlHeight,large:f.controlHeightLG};if(_===!0)return z?I[z]:I.middle;if(_||_===0)return _},q=X()&&j(d||(d=r()([`
        label {
