"use strict";(self.webpackChunk_yuntijs_ui=self.webpackChunk_yuntijs_ui||[]).push([[62242],{12891:function(re,Q,u){u.d(Q,{Z:function(){return N}});var R=u(86818),Z=u(74032),D=u(94644),E=u(82014);const L=(0,E.Z)("Menu",[["line",{x1:"4",x2:"20",y1:"12",y2:"12",key:"1e0a9i"}],["line",{x1:"4",x2:"20",y1:"6",y2:"6",key:"1owob3"}],["line",{x1:"4",x2:"20",y1:"18",y2:"18",key:"yk5zj1"}]]);var F=u(75271),$=u(40863),G=u(16713),B=u(47512),A=u(53082),W,T,j,h,v;function O(a,p){return p||(p=a.slice(0)),Object.freeze(Object.defineProperties(a,{raw:{value:Object.freeze(p)}}))}var P=(0,B.kc)(function(a,p){var c=a.token,S=a.css,C=a.stylish,i=a.prefixCls,d=p.fullscreen,b=p.headerHeight;return{container:S(W||(W=O([`
        cursor: pointer;
        width: `,`px;
        height: `,`px;
        border-radius: `,`px;
