...
export const formatBulletList = (editor: LexicalEditor, blockType: BLOCK_TYPE_VALUE) => {
  if (blockType === 'bullet') {
...
export const formatCheckList = (editor: LexicalEditor, blockType: BLOCK_TYPE_VALUE) => {
  if (blockType === 'check') {
    formatParagraph(editor);
  } else {
...
export const formatQuote = (editor: LexicalEditor, blockType: BLOCK_TYPE_VALUE) => {
  if (blockType !== 'quote') {
    editor.update(() => {
      const selection = $getSelection();
...
export const formatCode = (editor: LexicalEditor, blockType: BLOCK_TYPE_VALUE) => {
  if (blockType !== 'code') {
    editor.update(() => {
