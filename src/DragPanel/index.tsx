...
export const DragPanel: React.FC<DragPanelProps> = memo(props => {
  const { title, classNames, defaultPosition, onPositionChange, ...otherProps } = props;
  ...
  const _classNames = typeof classNames === 'function' ? classNames({ props }) : classNames;
  ...
  return (
    <Drawer
      ...
      classNames={{
        ..._classNames,
        wrapper: cx(styles.wrapper, _classNames?.wrapper),
        section: cx(styles.section, _classNames?.section),
      }}
      destroyOnHidden
      drawerRender={drawer => (
        <Draggable
